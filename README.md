...
- `data/workplace-deaths-backfill.json` - individual work-related death backfill; official/research fatality totals are shown in the app context panel, not mapped as aggregate records.
